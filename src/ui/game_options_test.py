...
class GameOptionsTest(unittest.TestCase):
  def test_default_options(self):
    ...
    self.assertEqual(1, game_options.animation_speed_multiplier)
  ...
  def test_custom_options(self):
    game_options = GameOptions(animation_speed_multiplier=10,
    ...
    self.assertEqual(10, game_options.animation_speed_multiplier)
